...
from .models import (
    AccountHolder, Branch, AdditionalDetail, Image, Event, Review, EcosystemCriteria
)
...
class AdditionalDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'saturday_opening_time', 'saturday_closing_time', 'delivery_available', 'delivery_range',
            'service_type', 'service_categories',
            'created_at', 'updated_at', 'images', 'events', 'reviews'
        ]
        read_only_fields = ['created_at', 'updated_at']
...
class EcosystemCriteriaSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = [
            ...
            'ce_features', 'ce_menu_highlights',
            'ce_state'
        ]
        read_only_fields = ['id']