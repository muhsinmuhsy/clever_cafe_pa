...
class AccountHolder(models.Model):
    user = models.ForeignKey(
        User, limit_choices_to={'is_trade_service_user': True},
        on_delete=models.CASCADE, blank=True, null=True,
        related_name='ts_accountholder_user'
    )
...
class Branch(models.Model):
    ...
    state = models.ForeignKey(State, blank=True, null=True, on_delete=models.SET_NULL, related_name='trade_service_branch')
...
class AdditionalDetail(models.Model):
    user = models.ForeignKey(
        User, limit_choices_to={'is_trade_service_user': True},
        on_delete=models.CASCADE, blank=True, null=True,
        related_name='ts_additional_detail_user'
    )
    branch = models.OneToOneField(Branch, on_delete=models.SET_NULL, null=True, blank=True)
    logo = models.ImageField(upload_to='trade-service/additional-detail/logo', blank=True, null=True)
    menu = models.ImageField(upload_to='trade-service/additional-detail/menu', blank=True, null=True)
    cover_image = models.ImageField(upload_to='trade-service/additional-detail/cover', blank=True, null=True)
...
class Image(models.Model):
    ...
    image = models.ImageField(upload_to='trade-service/additional-detail/images', null=True, blank=True)
    created_at = models.DateTimeField(auto_now_add=True, blank=True, null=True)  
    updated_at = models.DateTimeField(auto_now=True, blank=True, null=True)
...
class EcosystemCriteria(models.Model):
    user = models.ForeignKey(
        User, limit_choices_to={'is_trade_service_user': True},
        on_delete=models.CASCADE, blank=True, null=True,
        related_name='ts_ecosystem_criteria_user'
    )
    branch = models.OneToOneField(Branch, on_delete=models.SET_NULL, null=True, blank=True)
    ...
    ce_features = models.ManyToManyField(
        ...
        related_name='ts_ecosystemcriteria_feature'
    )
    ce_menu_highlights = models.ManyToManyField(
        'cafe_entrepreneurship.MenuHighlight', blank=True,
        related_name='ts_ecosystemcriteria_feature'
    )
    ce_state = models.ManyToManyField(
        State, blank=True,
        related_name='ts_ecosystemcriteria_state_for_ce'
    )
...
class MediaGallery(models.Model):
    user = models.ForeignKey(
        User, limit_choices_to={'is_trade_service_user': True},
        on_delete=models.CASCADE, blank=True, null=True,
        related_name='ts_media_gallery_user'
    )
